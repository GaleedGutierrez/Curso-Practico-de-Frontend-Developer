...
export const PRODUCT_DETAIL_CONTAINER = document.querySelector('.main > .product-detail');
const PRODUCT_DETAIL_CLOSE_ICON = document.querySelector('.product-detail__close-icon');
